...
class OCServiceAccountTest(unittest.TestCase):
    ...
    @mock.patch('oc_serviceaccount.OCServiceAccount._locate_oc_binary')
    ...
    def test_binary_lookup_fallback(self, mock_env_get, mock_path_exists):
        ...
        self.assertEqual(OCServiceAccount._locate_oc_binary(), 'oc')
    ...
    def test_binary_lookup_in_path(self, mock_env_get, mock_path_exists):
        ...
        self.assertEqual(OCServiceAccount._locate_oc_binary(), oc_bin)
